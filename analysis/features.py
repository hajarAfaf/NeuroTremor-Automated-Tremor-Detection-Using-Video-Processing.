...
def extract_features(signal, fs):
    """
    Extrait des features biomécaniques et de signal du mouvement.

    Args:
        signal (np.array): Le signal de mouvement (positions Y du poignet).
        fs (int): La fréquence d'échantillonnage du signal (frames par seconde).

    Returns:
        list: Une liste de features extraites, ou None si le signal est trop court.
    """
